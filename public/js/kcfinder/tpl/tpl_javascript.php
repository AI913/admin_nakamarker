...
<?php //masahi6 2012-02-20 16:56:59 +0900 ?>
_.user = "<?php if (!empty($_GET['user'])) { echo htmlspecialchars(trim($_GET['user']));} ?>";
<?php //masahi6 2012-02-22 17:43:56 +0900 ?>
_.mypath = "<?php if (!empty($_GET['mypath'])) { echo htmlspecialchars(trim($_GET['mypath']));} ?>";
